Fork note: As of 2025-02-05 zabbix-export is mostly compatible with Zabbix 7.2.3 using the latest pyzabbix (1.3.1). Import has not been maintained since this repo was forked.
